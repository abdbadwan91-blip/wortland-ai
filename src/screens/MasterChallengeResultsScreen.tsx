    ...
    <div className={`screen fade-in ${styles.wrap}`} data-master-results>
      ...
      <div className={styles.actions}>
        ...
        <button
          type="button"
          className="btn-blue"
          onClick={() => handleNextChallenge({ setScreen, setSelectedMode, setSelectedLevel }, { currentMode: 'master', level: selectedLevel || profile.level || 1, passed: Boolean(rewards?.mapAdvance), onRetry: onPlayAgain })}
          data-next-challenge
        >
          {t('mc.nextChallenge')}
        </button>
