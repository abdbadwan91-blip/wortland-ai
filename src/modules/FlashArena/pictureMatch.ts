...
export interface PictureQuestion {
  ...
  /** N options including target, shuffled (level-driven) */
...
/** Build one Picture Match question from a target LO */
...
/**
 * Session from topic pool — size & option count from Level Wheel params.
 */
